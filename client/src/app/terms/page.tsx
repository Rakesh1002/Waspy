  ...
  return (
    <Container className="py-16 max-w-3xl">
      ...
      <div className="prose dark:prose-invert">
        ...
        <div className="mb-8">
          <p>
            The website located at waspy.unquest.ai (the &quot;Site&quot;) is a copyrighted work belonging to UnQuest, Inc. 
            (&quot;Company&quot;, &quot;us&quot;, &quot;our&quot;, and &quot;we&quot;). Certain features of the Site may be 
            subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features. 
        ...
        <div className="mb-8 font-semibold">
          <p className="mb-4">
            ...
            BY ACCESSING OR USING THE SITE, YOU ARE ACCEPTING THESE TERMS (ON BEHALF OF YOURSELF OR THE ENTITY THAT YOU REPRESENT), AND YOU 
            ...
            ENTITY THAT YOU REPRESENT). YOU MAY NOT ACCESS OR USE THE SITE OR ACCEPT THE TERMS IF YOU ARE NOT AT LEAST 18 YEARS OLD. IF YOU 
            DO NOT AGREE WITH ALL OF THE PROVISIONS OF THESE TERMS, DO NOT ACCESS AND/OR USE THE SITE.
          </p>
        </div>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            registration information you submit is truthful and accurate; (b) you will maintain the accuracy of such information. You 
            may delete your Account at any time, for any reason, by following the instructions on the Site. Company may suspend or 
            terminate your Account in accordance with Section 7.
          </p>

          <h3 className="text-xl mb-2 mt-4">1.2 Account Responsibilities</h3>
          <p>
            You are responsible for maintaining the confidentiality of your Account login information and are fully responsible for all 
            activities that occur under your Account. You agree to immediately notify Company of any unauthorized use, or suspected 
            unauthorized use of your Account or any other breach of security. Company cannot and will not be liable for any loss or 
        ...
        <section className="mb-8">
          ...
          <p>
            You acknowledge that all the intellectual property rights, including copyrights, patents, trade marks, and trade secrets, in 
            the Site and its content are owned by Company or Company&apos;s suppliers. Neither these Terms (nor your access to the Site) 
            transfers to you or any third party any rights, title or interest in or to such intellectual property rights, except for the 
            limited access rights expressly set forth in Section 2.1. Company and its suppliers reserve all rights not granted in these 
            Terms. There are no implied licenses granted under these Terms.
          </p>

          <h3 className="text-xl mb-2 mt-4">2.6 Feedback</h3>
          <p>
            If you provide Company with any feedback or suggestions regarding the Site (&quot;Feedback&quot;), you hereby assign to Company 
            all rights in such Feedback and agree that Company shall have the right to use and fully exploit such Feedback and related 
            information in any manner it deems appropriate. Company will treat any Feedback you provide to Company as non-confidential and 
            non-proprietary. You agree that you will not submit to Company any information or ideas that you consider to be confidential 
            or proprietary.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            the Site, (b) your violation of these Terms or (c) your violation of applicable laws or regulations. Company 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            (collectively, &quot;Third-Party Links & Ads&quot;). Such Third-Party Links & Ads are not under the control of 
            ...
            or make any representations with respect to Third-Party Links & Ads. You use all Third-Party Links & Ads at your 
            own risk, and should apply a suitable level of caution and discretion in doing so. When you click on any of the 
          ...
          <p>
            You hereby release and forever discharge Company (and our officers, employees, agents, successors, and assigns) from, 
            and hereby waive and relinquish, each and every past, present and future dispute, claim, controversy, demand, right, 
            obligation, liability, action and cause of action of every kind and nature (including personal injuries, death, and 
            property damage), that has arisen or arises directly or indirectly out of, or that relates directly or indirectly to, 
            the Site (including any interactions with, or act or omission of, other Site users or any Third-Party Links & Ads).
          </p>
          <p className="mt-4 font-semibold">
            ...
            WHICH STATES: &quot;A GENERAL RELEASE DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR OR RELEASING PARTY DOES NOT KNOW OR 
        ...
        <section className="mb-8">
          ...
          <p className="font-semibold">
            ...
            EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES AND CONDITIONS OF ANY KIND, WHETHER EXPRESS, IMPLIED, OR STATUTORY, INCLUDING 
            ALL WARRANTIES OR CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, QUIET ENJOYMENT, ACCURACY, OR 
            NON-INFRINGEMENT. WE (AND OUR SUPPLIERS) MAKE NO WARRANTY THAT THE SITE WILL MEET YOUR REQUIREMENTS, WILL BE AVAILABLE 
            ON AN UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE BASIS, OR WILL BE ACCURATE, RELIABLE, FREE OF VIRUSES OR OTHER 
        ...
        <section className="mb-8">
          ...
          <p className="font-semibold mb-4">
            ...
            INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES ARISING FROM OR RELATING TO THESE TERMS OR YOUR USE OF, OR INABILITY TO USE, THE 
            SITE, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. ACCESS TO, AND USE OF, THE SITE IS AT YOUR 
            OWN DISCRETION AND RISK, AND YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR DEVICE OR COMPUTER SYSTEM, OR LOSS 
          ...
          <p className="font-semibold mb-4">
            ...
            WILL AT ALL TIMES BE LIMITED TO A MAXIMUM OF FIFTY US DOLLARS. THE EXISTENCE OF MORE THAN ONE CLAIM WILL NOT ENLARGE THIS 
            LIMIT. YOU AGREE THAT OUR SUPPLIERS WILL HAVE NO LIABILITY OF ANY KIND ARISING FROM OR RELATING TO THESE TERMS.
          </p>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            Account and right to access and use the Site will terminate immediately. Company will not have any liability whatsoever 
            to you for any termination of your rights under these Terms, including for termination of your Account. Even after your 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            an e-mail to the last e-mail address you provided to us (if any), and/or by prominently posting notice of the changes on 
            our Site. You are responsible for providing us with your most current e-mail address. In the event that the last e-mail 
            address that you have provided us is not valid, or for any reason is not capable of delivering to you the notice described 
            above, our dispatch of the e-mail containing such notice will nonetheless constitute effective notice of the changes 
            described in the notice. Continued use of our Site following notice of such changes shall indicate your acknowledgement 
          ...
          <p className="mb-4">
            Please read the following arbitration agreement in this Section (the &quot;Arbitration Agreement&quot;) carefully. It 
            requires you to arbitrate disputes with Company, its parent companies, subsidiaries, affiliates, successors and assigns 
            and all of their respective officers, directors, employees, agents, and representatives (collectively, the &quot;Company 
            Parties&quot;) and limits the manner in which you can seek relief from the Company Parties.
          </p>

          <div className="pl-4">
            <h4 className="text-lg mb-2 mt-4">(a) Applicability of Arbitration Agreement</h4>
            <p className="mb-4">
              You agree that any dispute between you and any of the Company Parties relating in any way to the Site, 
              the services offered on the Site (the &quot;Services&quot;) or these Terms will be resolved by binding 
            ...
            <h4 className="text-lg mb-2 mt-4">(b) Informal Dispute Resolution</h4>
            <p className="mb-4">
              ...
              to resolve Disputes can result in a prompt, low‐cost and mutually beneficial outcome.
            </p>

            <h4 className="text-lg mb-2 mt-4">(c) Arbitration Rules and Forum</h4>
            <p className="mb-4">
              These Terms evidence a transaction involving interstate commerce; and notwithstanding any other provision 
              herein with respect to the applicable substantive law, the Federal Arbitration Act, 9 U.S.C. § 1 et seq., 
              will govern the interpretation and enforcement of this Arbitration Agreement and any arbitration proceedings.
            </p>
            ...
            <p className="mb-4">
              ...
              without limitation, any dispute related to the interpretation, applicability, enforceability or formation of 
              this Arbitration Agreement or any portion of the Arbitration Agreement.
            </p>

            <h4 className="text-lg mb-2 mt-4">(e) Waiver of Jury Trial</h4>
            <p className="mb-4 font-semibold">
              EXCEPT AS SPECIFIED IN SECTION 8.2(A) YOU AND THE COMPANY PARTIES HEREBY WAIVE ANY CONSTITUTIONAL AND 
              STATUTORY RIGHTS TO SUE IN COURT AND HAVE A TRIAL IN FRONT OF A JUDGE OR A JURY.
            </p>

            <h4 className="text-lg mb-2 mt-4">(f) Waiver of Class or Other Non-Individualized Relief</h4>
            <p className="mb-4 font-semibold">
              YOU AND COMPANY AGREE THAT, EXCEPT AS SPECIFIED IN SUBSECTION 8.2(H) EACH OF US MAY BRING CLAIMS AGAINST 
              THE OTHER ONLY ON AN INDIVIDUAL BASIS AND NOT ON A CLASS, REPRESENTATIVE, OR COLLECTIVE BASIS.
            </p>

            <h4 className="text-lg mb-2 mt-4">(g) Attorneys&apos; Fees and Costs</h4>
            <p className="mb-4">
              The parties shall bear their own attorneys&apos; fees and costs in arbitration unless the arbitrator finds 
              that either the substance of the Dispute or the relief sought in the Request was frivolous or was brought 
              for an improper purpose.
            </p>

            <h4 className="text-lg mb-2 mt-4">(h) Batch Arbitration</h4>
            <p className="mb-4">
              To increase the efficiency of administration and resolution of arbitrations, you and Company agree that in 
              the event that there are 100 or more individual Requests of a substantially similar nature filed against 
              Company by or with the assistance of the same law firm, group of law firms, or organizations, within a 30 
              day period, the JAMS shall administer the arbitration demands in batches.
            </p>
            ...
            <p className="mb-4">
              ...
              notice of your decision to opt out to: 1111B S Governors Ave STE 25082 Dover, DE, 19904 US, or email to 
              rakesh@unquest.ai, within 30 days after first becoming subject to this Arbitration Agreement.
            </p>
            ...
            <p className="mb-4">
              ...
              becoming effective by writing Company at the address provided above.
            </p>
          </div>
          ...
          <p className="mb-4">
            Company is located at the address in Section 8.8. If you are a California resident, you may report complaints 
          ...
          <p className="mb-4">
            ...
            whether Company posts notices on the Site or communicates with you via email. For contractual purposes, you 
            ...
            satisfy any legal requirement that such communications would satisfy if it were be in a hardcopy writing. The 
          ...
          <p className="mb-4">
            ...
            is, for any reason, held to be invalid or unenforceable, the other provisions of these Terms will be unimpaired 
            and the invalid or unenforceable provision will be deemed modified so that it is valid and enforceable to the 
            maximum extent permitted by law.
          </p>

          <h3 className="text-xl mb-2 mt-4">8.7 Copyright/Trademark Information</h3>
          <p className="mb-4">
            Copyright © {new Date().getFullYear()} UnQuest, Inc. All rights reserved. All trademarks, logos and service marks 
          ...
          <div className="mb-4">
            ...
            <p>Email: <a href="mailto:rakesh@unquest.ai" className="text-primary hover:underline">rakesh@unquest.ai</a></p>
          </div>
        </section>
      </div>
    </Container>

...
import { MessageSquare, ShoppingCart, Bell, Headphones, Shield } from "lucide-react";
...
const caseStudies = [
  {
    icon: MessageSquare,
    title: "Marketing",
    description: "Run broadcast campaigns with structured, automated messages to engage audiences who opt-in.",
    example: "Send marketing messages during seasonal campaigns, product promotions, or special offers. Offer personalized reengagement for abandoned carts."
  },
  {
    icon: ShoppingCart,
    title: "Commerce",
    description: "Create immersive shopping experiences within WhatsApp conversations. Display products and enable cart functionality.",
    example: "Implement automated selling for ready-made food and beverages, with integrated payment processing where available."
  },
  {
    icon: Bell,
    title: "Utility",
    description: "Send timely, relevant messages to opted-in customers for real-time updates and reminders.",
    example: "Deliver reminders, shipping notifications, and booking confirmations automatically."
  },
  {
    icon: Headphones,
    title: "Customer Service",
    description: "Provide efficient, scalable customer support through conversations with automation capabilities.",
    example: "Enable 24/7 support through chatbot integration, working alongside human agents."
  },
  {
    icon: Shield,
    title: "Authentication",
    description: "Verify user identity through business-initiated messages using one-time passcodes.",
    example: "Implement account verification, recovery, and integrity challenge scenarios."
  }
];
          ...
          <div className="grid gap-8">
            {caseStudies.slice(0, 2).map((study, i) => (
              ...
              >
                ...
                <p className="mt-4 text-muted-foreground text-lg">{study.description}</p>
